...
@section('contenido')
    <div class="md:flex md:justify-center md:gap-4 ">
        <div class="md:w-4/12">
            <img src="{{ asset ('img/register.png')}}" alt="Imagen de registro de usuarios">
        ...
        <div class="md:w-4/12  bg-white p-6 rounded-lg shadow-xl">
             <form method="POST" action="/register" novalidate>
                @csrf
                <div class="mb-5">
                    <label for="name" class="mb-2 block uppercase text-gray-500 font-bold"></label>
                    Nombre
                    </label>
                    <input type="text"
                            id="name"
                ...
                <div class="mb-5">
                    <label for="username" class="mb-2 block uppercase text-gray-500 fotn-bold"></label>
                        Username
                    </label>
                    <input type="text"
                            id="username"
                ...
                <div class="mb-5">
                    <label for="password_confirmation" class="mb-2 block uppercase text-gray-500 fotn-bold"></label>
                        Password
                    </label>
                    <input type="password"
