...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="bg-gray-100">
        ...
        <div class="container mx-auto flex justify-between items-center">
            ...
            <nav class="flex gap-2 items-center">
             ...
             <form method="POST" action="{{route('logout')}}" >
                @csrf
                <button type="submit" class="font-bold"  href="{{route('logout')}}">Cerrar Sesion</button>
             </form>    
            </nav>
            ...
            @guest
            <nav class="flex gap-2 items-center">
                <a class="font-bold" href="{{route('login')}}">Login</a>
                <a class="font-bold"  href="{{route('register')}}">Crear Cuenta</a>
            </nav>
            @endguest
        ...
        <footer class=" mt-10 text-center p-5 text-gray-500 font-bold">
            DevStabram -  todos los derechos reservados {{now()->year}}
        </footer>
