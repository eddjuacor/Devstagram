...
@section('contenido')
    <div class="md:flex md:items-center">
        ...
        <div class="md:w-1/2 p-10 bg-white shadow-xl rounded-xl mt-10 md:mt-0 ">
            <form method="POST" action="{{route('posts.store')}}" novalidate>
                @csrf
                <div class="mb-5">
                    <label for="titulo" class="mb-2 block uppercase text-gray-500 font-bold"></label>
                    Titulo
                    </label>
                    <input type="text"
                            id="titulo"
                            name="titulo"
                            placeholder="Titulo de la descripcion"
